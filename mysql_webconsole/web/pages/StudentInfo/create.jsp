...
<html xmlns=" http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>新建<%=StudentInfo.TABLE_ALIAS%></title>
...
<div class="content"><!-- content start -->
   <h3 class="breadcrumb">
   <span class="current">您现在的位置：<%=StudentInfo.TABLE_ALIAS%>管理&gt;<a target="_self" href="pages/StudentInfo/list.action"><%=StudentInfo.TABLE_ALIAS%>管理</a>&gt;<a target="_self" href="pages/StudentInfo/create.action">新建<%=StudentInfo.TABLE_ALIAS%></a></span>
  </h3>
   
  <h4 class="warning">请填写以下信息完成注册。加“*”为必填项。</h4>
  
  <s:form id="domain" action="pages/StudentInfo/save.action" method="post">
  
			<s:hidden id="stuId" name="stuId" />
  ...
  <table class="table_form">
    <!-- ONGL access static field: @package.class@field or @vs@field -->
		...
		<tr>	
			...
			<td>
			<input value="${model.stuname}"  id="stuname" name="stuname"  maxlength="50" class="required " required="true"/>
			</td>
