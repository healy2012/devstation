...
<html xmlns=" http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>新建<%=TcamsGroup.TABLE_ALIAS%></title>
...
<div class="content"><!-- content start -->
   <h3 class="breadcrumb">
   <span class="current">您现在的位置：<%=TcamsGroup.TABLE_ALIAS%>管理&gt;<a target="_self" href="pages/TcamsGroup/list.action"><%=TcamsGroup.TABLE_ALIAS%>管理</a>&gt;<a target="_self" href="pages/TcamsGroup/create.action">新建<%=TcamsGroup.TABLE_ALIAS%></a></span>
  </h3>
   
  <h4 class="warning">请填写以下信息完成注册。加“*”为必填项。</h4>
  
  <s:form id="domain" action="pages/TcamsGroup/save.action" method="post">
  ...
  <table class="table_form">
    <!-- ONGL access static field: @package.class@field or @vs@field -->
		...
		<tr>	
			<th>
				<%=TcamsGroup.ALIAS_GROUP_NAME%>:
			</th>	
			<td>
			<input value="${model.groupName}"  id="groupName" name="groupName"  maxlength="255" class="required " required="true"/>
			</td>
		...
		<tr>	
			...
			<td>
			<input value="${model.groupDesc}"  id="groupDesc" name="groupDesc"  maxlength="255" class="" required="false"/>
			</td>
			<td class="place"><p class="annotation">提示信息</p></td>
		</tr>
		...
		<tr>	
			<th>
				<%=TcamsGroup.ALIAS_PARENT_GROUP_ID%>:
			</th>	
			<td>
			<input value="${model.parentGroupId}"  id="parentGroupId" name="parentGroupId"  maxlength="22" class="required validate-integer " required="true"/>
			</td>
			<td class="place"><p class="annotation">提示信息</p></td>
		</tr>
		...
		<tr>	
			<th>
				<%=TcamsGroup.ALIAS_LEVEL_ID%>:
			</th>	
			<td>
			<input value="${model.levelId}"  id="levelId" name="levelId"  maxlength="22" class="required validate-integer " required="true"/>
			</td>
			<td class="place"><p class="annotation">提示信息</p></td>
		</tr>
		...
		<tr>	
			<th>
				<%=TcamsGroup.ALIAS_GROUP_TYPE%>:
			</th>	
			<td>
			<input value="${model.groupType}"  id="groupType" name="groupType"  maxlength="22" class="required validate-integer " required="true"/>
			</td>
			<td class="place"><p class="annotation">提示信息</p></td>
		</tr>
		...
		<tr>	
			<th>
				<%=TcamsGroup.ALIAS_SYSTEM_ID%>:
			</th>	
			<td>
			<input value="${model.systemId}"  id="systemId" name="systemId"  maxlength="22" class="required validate-integer " required="true"/>
			</td>
			<td class="place"><p class="annotation">提示信息</p></td>
		</tr>
