...
<html lang='zh-CN' xml:lang='zh-CN' xmlns='http://www.w3.org/1999/xhtml'>
	<head>
		...
		<title>Static Radio Tree Demo</title>
		<link rel="stylesheet"
			href="<%=request.getContextPath()%>/global/css/tree/zTreeStyle.css"
			type="text/css">
	...
	<body>
		<div>
			<emag:tree builder="cn.emag.demo.web.ajax.DemoStaticTreeBuilder"
				callback="onSelect" checkable="true" radio="true" />
		</div>
	</body>
</html>