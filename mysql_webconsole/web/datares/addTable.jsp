...
<div class="content"><!-- content start -->
  ...
  <s2:form id="reg" action="datares/saveTable.action">
  <table class="table_form">
    <tr>
      <th>表名称：</th>
      <td><input name="table.tab_name" id="tab_name" type="text" value="${table.tab_name}" class="required" maxlength="30"/></td>
      <td class="place"><p class="annotation">不超过30个字符</p></td>
    </tr>
    <tr>
      <th>物理表名：</th>
      <td><input name="table.tab_sqlname" id="tab_sqlname" type="text" value="${table.tab_sqlname}" class="required" maxlength="30"/></td>
      <td class="place"><p class="annotation">不超过30个字符</p></td>
    </tr>
  </table>
