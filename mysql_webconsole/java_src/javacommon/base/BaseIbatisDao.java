...
public abstract class BaseIbatisDao<E,PK extends Serializable> extends SqlMapClientDaoSupport implements EntityDao<E,PK> {
	...
	public static Page pageQuery(SqlMapClientTemplate sqlMapClientTemplate,String statementName,String countStatementName, PageRequest pageRequest) {
		...
		otherFilters.put("pageStart", page.getFirstResult());
		otherFilters.put("pageEnd", page.getPageSize());
		...
		List list = sqlMapClientTemplate.queryForList(statementName, parameterObject);
		//list = sqlMapClientTemplate.queryForList(statementName, parameterObject,page.getFirstResult(),page.getPageSize());
		page.setResult(list);
		return page;
	}
