package cn.emag.datares.dbmodel.provider.db.table.model;



import java.util.List;

import cn.emag.datares.dbmodel.GeneratorProperties;
import cn.emag.datares.dbmodel.provider.db.table.model.ForeignKey.ReferenceKey;
import cn.emag.datares.dbmodel.provider.db.table.model.util.ColumnHelper;
import cn.emag.datares.dbmodel.util.GLogger;
import cn.emag.datares.dbmodel.util.StringHelper;
import cn.emag.datares.dbmodel.util.TestDataGenerator;
import cn.emag.datares.dbmodel.util.typemapping.ActionScriptDataTypesUtils;
import cn.emag.datares.dbmodel.util.typemapping.DatabaseDataTypesUtils;
import cn.emag.datares.dbmodel.util.typemapping.JavaPrimitiveTypeMapping;
