...
Rectangle
{
    ...
    Row
    {
        ...
        ToolBtn
        {
            index:0
            state:"checked"
            picSrc: "qrc:/Image/ico_Examine.png"
            btnText:"电脑体检"
        ...
        {
            index:1
            picSrc: "qrc:/Image/ico_dsmain.png"
            btnText:"木马查杀"
            onClicked:toolbar.current=btnIndex
        }
        ToolBtn
        {
            index:2
            picSrc: "qrc:/Image/ico_SysRepair.png"
            btnText:"系统修复"
            onClicked:toolbar.current=btnIndex
        }
        ToolBtn
        {
            index:3
            picSrc: "qrc:/Image/ico_TraceCleaner.png"
            btnText:"电脑清理"
            onClicked:toolbar.current=btnIndex
        }
        ToolBtn
        {
            index:4
            picSrc: "qrc:/Image/ico_SpeedupOpt.png"
            btnText:"优化加速"
            onClicked:toolbar.current=btnIndex
        }
        ToolBtn
        {
            index:5
            picSrc: "qrc:/Image/ico_expert.png"
            btnText:"电脑专家"
            onClicked:toolbar.current=btnIndex
        }
        ToolBtn
        {
            index:6
            picSrc: "qrc:/Image/ico_diannaomenzhen.png"
            btnText:"电脑门诊"
            onClicked:toolbar.current=btnIndex
        }
        ToolBtn
        {
            index:7
            picSrc: "qrc:/Image/ico_softmgr.png"
            btnText:"软件管家"
            onClicked:toolbar.current=btnIndex
        }
    }
